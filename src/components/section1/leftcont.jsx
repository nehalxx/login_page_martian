...
const Leftcont = () => {
  ...
  return (
    ...
    <div className="h-screen bg-white w-30 border-r border-gray-100 flex flex-col items-center py-4 gap-3">
      ...
      {/* HOME */}
      <div onClick={() => navigate('/home')} className="flex flex-col items-center justify-center w-full py-3 hover:bg-gray-100 cursor-pointer group">
      ...
      <div onClick={() => navigate ('/fset') } className="flex flex-col items-center justify-center w-1/3 py-3 hover:bg-gray-100 cursor-pointer group">
